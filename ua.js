function BrowserType() { 
  ...
  console.log('系统版本=====>', systemVs)
  console.log('平台=====>', platform)
  console.log('内核=====>', engine)
  console.log('载体（浏览器）=====>', supporter)
  console.log('内核版本=====>', engineVs)
  console.log('载体版本=====>', supporterVs)
  console.log('外壳=====>', shell)
  console.log('外壳版本=====>', shellVs)
